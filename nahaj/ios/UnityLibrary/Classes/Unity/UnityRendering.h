...
int                                 proxySwap;         // Counts times proxy RTs have swapped since last display link present (-1 when newly recreated)
int                                 bufferInUse;       // [bool] Command buffer currently drawing into proxy RT
